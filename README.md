...
Unlike many other firmware components, the Intel ME firmware can't be disabled 
as it is tightly integrated in the boot process, nor can it be reimplemented as
it is signed.
